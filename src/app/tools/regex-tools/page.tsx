...
function Tooltip({ text }: { text: string }) {
  return (
    <span className="absolute left-6 top-1/2 -translate-y-1/2 z-10 w-max bg-slate-800 text-xs text-slate-200 rounded px-2 py-1 shadow-lg border border-slate-700 pointer-events-none opacity-0 group-hover:opacity-100 transition-opacity">
      {text}
    </span>
  )
}
  ...
  return (
    <main className="min-h-screen bg-gray-950 flex flex-col items-center px-2" style={{ paddingTop: '5.5rem' }}>
      <div className="w-full max-w-2xl">
        <h1 className="text-3xl font-bold text-center mb-2 text-white">Regex Tester & Creator</h1>
        ...
        <div className="mb-2 relative group flex items-center">
          <label className="text-slate-300 text-sm mr-2">Pattern</label>
          <InformationCircleIcon className="h-4 w-4 text-blue-400 cursor-pointer" />
        ...
        <input
          ...
          className="w-full bg-slate-800 text-slate-200 rounded-lg px-3 py-2 border border-slate-700 mb-2"
          placeholder="Regex pattern (e.g. \\d+)"
        />

        <div className="mb-2 relative group flex items-center">
          <label className="text-slate-300 text-sm mr-2">Flags</label>
          <InformationCircleIcon className="h-4 w-4 text-blue-400 cursor-pointer" />
        ...
        <input
          ...
          className="bg-slate-800 text-slate-200 rounded-lg px-3 py-2 border border-slate-700 mb-2"
        ...
        <div className="mb-2 relative group flex items-center">
          <label className="text-slate-300 text-sm mr-2">Replacement</label>
          <InformationCircleIcon className="h-4 w-4 text-blue-400 cursor-pointer" />
        ...
        <div className="mb-2 relative group flex items-center">
          <label className="text-slate-300 text-sm mr-2">Test Text</label>
          <InformationCircleIcon className="h-4 w-4 text-blue-400 cursor-pointer" />
        ...
        <textarea
          ...
          className="w-full h-32 bg-slate-800 text-slate-200 rounded-lg p-4 border border-slate-700 focus:outline-none focus:ring-2 focus:ring-blue-500 mb-3"
          placeholder="Paste or type your test text here..."
        />

        {regexError && <div className="text-red-400 text-xs mb-2">{regexError}</div>}
        ...
        <textarea
          ...
          value={output}
          readOnly
          className="w-full h-32 bg-slate-800 text-slate-200 rounded-lg p-4 border border-slate-700 focus:outline-none mb-2"
        />
      </div>
    </main>
  )
